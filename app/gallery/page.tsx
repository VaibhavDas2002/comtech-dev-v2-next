              ...
              >
                ...
                <div className="absolute inset-0 p-5 flex flex-col justify-between text-white">
                  <div className="flex justify-between items-start">
                    <span className="px-2.5 py-0.5 rounded-md bg-slate-900/80 text-[#E9A51A] text-[10px] font-bold uppercase tracking-wider backdrop-blur-sm border border-slate-700">
                      {item.category}
                    </span>
                  ...
                  <div>
                    ...
                    {item.location && (
                      <div className="flex items-center gap-1 text-[11px] text-[#E9A51A] mt-0.5">
      ...
      {activeLightboxIndex !== null && filtered[activeLightboxIndex] && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-in fade-in">
          <button
            ...
            className="absolute top-4 right-4 p-3 text-white hover:text-[#E9A51A] rounded-full bg-slate-900/80 border border-slate-700 z-10 cursor-pointer"
          >
            <X className="w-6 h-6" />
          </button>
          ...
          <button
            ...
            className="absolute left-4 p-3 text-white hover:text-[#E9A51A] rounded-full bg-slate-900/80 border border-slate-700 z-10 cursor-pointer"
          >
          ...
          <button
            ...
            className="absolute right-4 p-3 text-white hover:text-[#E9A51A] rounded-full bg-slate-900/80 border border-slate-700 z-10 cursor-pointer"
          >
